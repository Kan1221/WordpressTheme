...
if ( ! function_exists( 'kandy_setup' ) ) :
	...
	function kandy_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'kandy' ),
		) );
 ...
 */
if ( is_admin() ) {
	require_once get_template_directory() . '/inc/plugins/register-plugins.php';
}
/**
 * ReduxFramework
 */
...
if ( !isset( $redux_owd )) {
 require_once  get_template_directory() . '/inc/admin/option-config.php';
}

//load page option
 require_once  get_template_directory() . '/inc/page-option.php';
